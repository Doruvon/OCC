...
app.get('/roomcnt',function(req,res){
	var host = req.hostname;
	switch(host){
		case "127.0.0.1": var dbname = "uropokeon"; break;
		case "localhost": var dbname = "oricha"; break;
...
app.post('/chara_img_get',function(req,res){
	...
	var host = req.hostname;
	switch(host){
		case "127.0.0.1": var gamename = "uropoke"; break;
		case "localhost": var gamename = "oricha"; break;
