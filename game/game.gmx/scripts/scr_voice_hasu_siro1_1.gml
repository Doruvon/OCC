...
ds_queue_enqueue(opp_words[? "s1_p2"],"[spr]hasu_bind_siro,0",0.1,"もっと喘いでもいいのだぞ？","どうした？#気持ち良いのだろう？");
...
ds_queue_enqueue(opp_words[? "s1_p4_0"],"[spr]hasu_bind_siro,1","よしよし#素直な良い子だ……",400,"さあ、ゆくぞ#たっぷり味わうといい",0.2);
...
ds_queue_enqueue(opp_words[? "s1_p5_0"],"[spr]hasu_bind_siro,2",0.15,0.1,0.05,"ぐるぅう……!!!");
...
ds_queue_enqueue(opp_words[? "s1_p4_1"],"[spr]hasu_bind_siro,1","ダメだ、逃しはしない……","嫌がってる癖に艶やかな声だな？","これが欲しいのだろう？#くれてやろう！",0.2);
...
ds_queue_enqueue(opp_words[? "s1_p5_1"],"[spr]hasu_bind_siro,2",0.15,0.1,0.05,"ぐるぅう……!!!");
...
ds_queue_enqueue(opp_words[? "s1_p6_0"],"[spr]hasu_stand,0",0.1,"ふふ、実に好かったぞ","私のを味わいたければ#また来るがいい",50);
...
ds_queue_enqueue(opp_words[? "s1_p6_1"],"[spr]hasu_stand,0",0.1,"ふふ、実に好かったぞ","私のを味わいたければ#また来るがいい",50);
